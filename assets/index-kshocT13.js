 ...
 */
  ...
  --gds-sys-shadow-xl-02: 0px 0px 0px 0px transparent;`;var pn={};const Pt=typeof process<"u"&&pn!==void 0,Hn=/iPad|iPhone|iPod/.test(Pt?"":navigator.userAgent);var zt,Ct,Tt,ee,mt,Ze,Je;function yn(){return Pt?[]:document.adoptedStyleSheets||[]}const gn=class Xe{constructor(){k(this,mt),k(this,zt,!te()),k(this,Ct,new Map),k(this,Tt,new Map),k(this,ee,yn())}static get instance(){return globalThis.__gdsGlobalStylesRegistryScoped?.[G]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[G]:new Xe}),globalThis.__gdsGlobalStylesRegistryScoped[G]}injectGlobalStyles(t,e){if(v(this,zt)){const s=Array.isArray(e)?e.map(r=>r.toString()).join(""):e.toString();V(this,mt,Ze).call(this,t,s)}else e.styleSheet&&V(this,mt,Je).call(this,t,e.styleSheet)}};zt=new WeakMap;Ct=new WeakMap;Tt=new WeakMap;ee=new WeakMap;mt=new WeakSet;Ze=function(n,t){if(Pt)return;let e=v(this,Tt).get(n);e||(e=document.createElement("style"),v(this,Tt).set(n,e)),e.textContent=t,document.head.appendChild(e)};Je=function(n,t){Pt||(v(this,Ct).set(n,t),document.adoptedStyleSheets=[...v(this,ee),...Array.from(v(this,Ct).values())])};let Sn=gn;const Ye=[kt`
    :host {
      ${O(qe)}
      ${O(Fe)}
    }
