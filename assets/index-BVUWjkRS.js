const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/all-components-BWxEH9oi.js","assets/video-DUy-lAXR.js","assets/form-xu0Lcglb.js"])))=>i.map(i=>d[i]);
...
`;var Mn=kn;class H extends Cn(Tn(pt)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const e={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...e,"aria-label":this.label}:{...e,role:"presentation"}}get svgContent(){const t=this.constructor;return this.solid?t._solidSVG:t._regularSVG}applyStroke(t){return this.stroke?t.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):t}generateAttributesString(t){return Object.entries(t).filter(([e,s])=>s!==void 0).map(([e,s])=>`${e}="${s}"`).join(`
    ...
    `];m([J({reflect:!0,attribute:"color-scheme"})],Z.prototype,"colorScheme",2);m([J({reflect:!0,attribute:"design-version"})],Z.prototype,"designVersion",2);m([ts("colorScheme")],Z.prototype,"_onColorSchemeChange",1);m([ts("designVersion")],Z.prototype,"_onDesignVersionChange",1);Z=m([We("gds-theme")],Z);N.define();var On=Object.getOwnPropertyDescriptor,Dn=(n,t,e,s)=>{for(var r=s>1?void 0:s?On(t,e):t,i=n.length-1,l;i>=0;i--)(l=n[i])&&(r=l(r)||r);return r};Z.define();globalThis.URLPattern||await It(()=>import("./index-DPyTNidZ.js"),[]);let De=class extends nt{constructor(){super(...arguments),this._router=new Qs(this,[{path:"/",render:()=>lt`<h1>Green testbed</h1>`},{path:"/green-testbed/all-components",render:()=>lt`<all-components></all-components>`,enter:(async n=>{await It(()=>import("./all-components-BWxEH9oi.js"),__vite__mapDeps([0,1]))})},{path:"/green-testbed/form",render:()=>lt`<form-view></form-view>`,enter:(async n=>{await It(()=>import("./form-xu0Lcglb.js"),__vite__mapDeps([2,1]))})}])}createRenderRoot(){return this}render(){return lt`<gds-theme><main>${this._router.outlet()}</main></gds-theme>`}};De=Dn([Ks("green-testbed-main")],De);export{En as A,$n as B,Lt as C,Wn as D,A as E,Nn as F,H as G,sn as H,O as I,N as J,fn as K,Sn as L,Hn as M,Z as N,tt as T,Gn as Z,m as _,kt as a,dn as b,ln as c,Pt as d,cn as e,k as f,We as g,lt as h,nt as i,V as j,v as k,F as l,Pn as m,pt as n,Ye as o,J as p,zn as q,Cn as r,Tn as s,Ks as t,$ as u,Vn as v,ts as w,je as x,qn as y,Fn as z};
