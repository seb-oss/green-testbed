import{f as qd,u as Zd,i as Xd,V as fs,r as re,a as z,h as v,g as S,T as Ps,E as fe,x as Ce,Z as Kd}from"./index-BFJjYUsS.js";/**
 * @license
...
`;var rc={};const Jn=typeof process<"u"&&rc!==void 0,ac=/iPad|iPhone|iPod/.test(navigator.userAgent);var xo,Ln,Wn,xr,_o,qa,wo,Za;function lc(){return Jn?[]:document.adoptedStyleSheets||[]}const dc=class Xa{constructor(){c(this,_o),c(this,wo),c(this,xo,!mr()),c(this,Ln,new Map),c(this,Wn,new Map),c(this,xr,lc())}static get instance(){return globalThis.__gdsGlobalStylesRegistryScoped?.[fs]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[fs]:new Xa}),globalThis.__gdsGlobalStylesRegistryScoped[fs]}injectGlobalStyles(t,s){if(a(this,xo)){const n=Array.isArray(s)?s.map(i=>i.toString()).join(""):s.toString();f(this,_o,qa).call(this,t,n)}else s.styleSheet&&f(this,wo,Za).call(this,t,s.styleSheet)}};xo=new WeakMap;Ln=new WeakMap;Wn=new WeakMap;xr=new WeakMap;_o=new WeakSet;qa=function(e,t){if(Jn)return;let s=a(this,Wn).get(e);s||(s=document.createElement("style"),a(this,Wn).set(e,s)),s.textContent=t,document.head.appendChild(s)};wo=new WeakSet;Za=function(e,t){Jn||(a(this,Ln).set(e,t),document.adoptedStyleSheets=[...a(this,xr),...Array.from(a(this,Ln).values())])};let Ka=dc;const G=[z`
    :host {
      ${re(ja)}
      ${re(Ua)}
    }
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Do=class extends Qs{constructor(t){if(super(t),this.it=fe,t.type!==Js.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===fe||t==null)return this._t=void 0,this.it=t;if(t===Ps)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}};Do.directiveName="unsafeHTML",Do.resultType=1;const ll=ks(Do),dh=z`
  @layer icon;
...
`;var Ro,Bo,ul,Mr,pl,Er,gl,Tr,fl,Rn,zr,Ar,yl,Dr,bl;let Ne=class extends ne{constructor(){super(...arguments),c(this,Bo),c(this,Mr),c(this,Er),c(this,Tr),c(this,Rn),c(this,Ar),c(this,Dr),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,c(this,Ro,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this.checkboxes.pop()}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",a(this,Ro))}render(){const e={"checkbox-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return v`<div
    ...
    </div>`}_syncOnDOMChange(){f(this,Rn,zr).call(this)}};Ro=new WeakMap;Bo=new WeakSet;ul=function(){return[f(this,Mr,pl).call(this),f(this,Er,gl).call(this),f(this,Dr,bl).call(this)].map(t=>v`${t}`)};Mr=new WeakSet;pl=function(){if(this.label)return v`<gds-form-control-header class="size-${this.size}">
...
`;var mh=vh;let Bn=class extends R{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>ye.instance.apply(this,"gds-menu-heading"))}render(){return Ce`<slot></slot>`}};Bn.styles=mh;Bn=o([S("gds-menu-heading")],Bn);var Ho;let vs=class extends xl(R){constructor(){super(...arguments),c(this,Ho,()=>{this.dispatchCustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0})})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",a(this,Ho)),ye.instance.apply(this,"gds-option")}render(){return v`<div><slot></slot></div>`}};Ho=new WeakMap;vs.styles=[_l];vs=o([S("gds-menu-item")],vs);let st=class extends Q{};st._regularSVG='<path d="M15 20L7 12L15 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';st._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.5303 3.46967C15.8232 3.76256 15.8232 4.23744 15.5303 4.53033L8.06066 12L15.5303 19.4697C15.8232 19.7626 15.8232 20.2374 15.5303 20.5303C15.2374 20.8232 14.7626 20.8232 14.4697 20.5303L6.46967 12.5303C6.32902 12.3897 6.25 12.1989 6.25 12C6.25 11.8011 6.32902 11.6103 6.46967 11.4697L14.4697 3.46967C14.7626 3.17678 15.2374 3.17678 15.5303 3.46967Z" fill="currentColor"/>';st._name="chevron-left";st._width=24;st._height=24;st._viewBox="0 0 24 24";st=o([S("gds-icon-chevron-left")],st);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var $u=Cu,Uo,Fl,ss,Pn,Dt,Ls,Lt,qo,hn,Zo,Xo,Il,Ko,Hl,un,Jo,oo,io,pn,gn,Ws;let V=class extends R{constructor(){super(...arguments),c(this,Uo),c(this,hn),c(this,Xo),c(this,Ko),c(this,un),this.open=!1,this.popupRole="dialog",this.label=void 0,this.placement="bottom-start",this.disableMobileStyles=!1,this.autofocus=!1,this.calcMinWidth=e=>`${e.offsetWidth}px`,this.calcMaxWidth=e=>"auto",this.calcMinHeight=e=>"auto",this.calcMaxHeight=e=>`${window.innerHeight-16}px`,this.nonmodal=!1,this.floatingUIMiddleware=V.DefaultMiddleware,this._trigger=void 0,this._anchor=void 0,this._isVirtKbVisible=!1,c(this,ss,void 0),c(this,Pn,!1),c(this,Dt,void 0),c(this,Ls,()=>{a(this,Lt).call(this,"cancel")&&(this.open=!1)}),c(this,Lt,e=>{const t=e==="show";return this.dispatchCustomEvent("gds-ui-state",{detail:{open:t,reason:e},bubbles:!1,composed:!1,cancelable:!0})}),c(this,qo,e=>{e.stopPropagation(),e.preventDefault(),a(this,Lt).call(this,"close")&&(this.open=!1,setTimeout(()=>this._trigger?.focus(),250))}),c(this,oo,e=>{(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),this.open=!0,a(this,Lt).call(this,"show")),e.key==="Escape"&&this.open&&a(this,Ls).call(this)}),c(this,io,e=>{e.preventDefault(),a(this,Lt).call(this,this.open?"close":"show")&&(this.open=!this.open)}),c(this,pn,()=>{const e=this._elDefaultSlot?.assignedElements()[0];this.updateComplete.then(()=>{e?.focus()})}),c(this,gn,e=>{const t=e,s=this._elDialog;if((t.clientX>0||t.clientY>0)&&s&&this.open){const i=s.getBoundingClientRect();!(i.top<=t.clientY&&t.clientY<=i.top+i.height&&i.left<=t.clientX&&t.clientX<=i.left+i.width)&&a(this,Lt).call(this,"close")&&(this.open=!1)}}),c(this,Ws,()=>{this.open&&a(this,Lt).call(this,"close")&&(this.open=!1)})}_handleTriggerRefChanged(){this.triggerRef?.then(e=>{e&&(this._trigger=e)})}_handleAnchorRefChanged(){this.anchorRef?.then(e=>{e&&(this._anchor=e)})}_handleTriggerChanged(){f(this,hn,Zo).call(this),f(this,Ko,Hl).call(this)}_handleAnchorChanged(){f(this,un,Jo).call(this)}connectedCallback(){super.connectedCallback(),ye.instance.apply(this,"gds-popover"),f(this,hn,Zo).call(this),this._handleOpenChange(),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.open&&(a(this,Ls).call(this),e.stopPropagation(),e.preventDefault())}),this.addEventListener("focusin",e=>{const t=e.target;t!==this&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"?this._isVirtKbVisible=!0:this._isVirtKbVisible=!1)}),this.addEventListener("blurin",e=>{this._isVirtKbVisible=!1})}disconnectedCallback(){super.disconnectedCallback(),f(this,Xo,Il).call(this),window.removeEventListener("scroll",a(this,Ws))}render(){return v`<slot
        name="trigger"
      ...
      <div ?hidden="${!this.open}">
        <dialog
          ...
          ?inert="${!this.open}"
          @close=${()=>this.open&&a(this,Ls).call(this)}
        >
          <header>
            <h2>${this.label}</h2>
            <gds-button
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ia=e=>!_h(e)&&typeof e.then=="function",Ha=1073741823;class Lu extends kl{constructor(){super(...arguments),this._$Cwt=Ha,this._$Cbt=[],this._$CK=new Au(this),this._$CX=new Du}render(...t){return t.find(s=>!Ia(s))??Ps}update(t,s){const n=this._$Cbt;let i=n.length;this._$Cbt=s;const r=this._$CK,l=this._$CX;this.isConnected||this.disconnected();for(let h=0;h<s.length&&!(h>this._$Cwt);h++){const u=s[h];if(!Ia(u))return this._$Cwt=h,u;h<i&&u===n[h]||(this._$Cwt=Ha,i=0,Promise.resolve(u).then(async g=>{for(;l.get();)await l.get();const m=r.deref();if(m!==void 0){const b=m._$Cbt.indexOf(u);b>-1&&b<m._$Cwt&&(m._$Cwt=b,m.setValue(g))}}))}return Ps}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const Wu=ks(Lu),Ou=z`
  @layer base, a11y;
...
`;var Fu=Bu,Ut,ni,ql,oi,ii,ri,Ot,ai,fn,li,di,ci,hi,Zl,Gn,jn,ui,Xl,pi,Kl,_s,ao;let K=class extends ne{constructor(){super(...arguments),c(this,ni),c(this,hi),c(this,ui),c(this,pi),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,c(this,Ut,void 0),c(this,oi,()=>v`
      <input
        id="trigger"
        role="combobox"
