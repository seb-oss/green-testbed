const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/all-components-CUb1i5ej.js","assets/video-C33iE8Ia.js","assets/form-DR_CJHgt.js"])))=>i.map(i=>d[i]);
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class We extends dn{constructor(e){if(super(e),this.it=A,e.type!==ln.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===A||e==null)return this._t=void 0,this.it=e;if(e===ee)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}We.directiveName="unsafeHTML",We.resultType=1;const fn=cn(We);var U,Ee,I,xe,Q,G,j,Ae,W,zt,ce,Vt;class hn{constructor(e){k(this,W),k(this,U,!et()),k(this,Ee,!1),k(this,I,[]),k(this,xe,[]),k(this,Q,new Map),k(this,G,new Map),k(this,j,[]),k(this,Ae,[]),this.host=e,this.host.addController(this)}hostConnected(){z(this,W,Vt).call(this)}has(e){return m(this,U)?m(this,G).has(e):m(this,Q).has(e)}inject(e,t){z(this,W,zt).call(this,e,t),z(this,W,ce).call(this)}clear(e){m(this,U)?this.host.updateComplete.then(()=>{m(this,G).get(e)?.remove(),m(this,G).delete(e)}):m(this,Q).delete(e),z(this,W,ce).call(this)}clearAll(){m(this,U)?this.host.updateComplete.then(()=>{m(this,G).forEach(e=>e.remove()),m(this,j).forEach(e=>e.remove()),m(this,G).clear(),q(this,j,[])}):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],m(this,Q).clear(),q(this,I,[]))}clearInitial(){m(this,U)?this.host.updateComplete.then(()=>{m(this,j).forEach(e=>e.remove()),q(this,j,[])}):q(this,I,[]),z(this,W,ce).call(this)}restoreInitial(){m(this,U)?m(this,Ae).forEach(e=>{m(this,j).push(e.cloneNode(!0))}):q(this,I,[...m(this,xe)]),z(this,W,ce).call(this)}}U=new WeakMap;Ee=new WeakMap;I=new WeakMap;xe=new WeakMap;Q=new WeakMap;G=new WeakMap;j=new WeakMap;Ae=new WeakMap;W=new WeakSet;zt=function(n,e){if(m(this,U)){let t=m(this,G).get(n);t||(t=document.createElement("style"),m(this,G).set(n,t)),t.textContent=e.cssText}else{if(!this.host.shadowRoot||!e.styleSheet)return;m(this,Q).set(n,e.styleSheet)}};ce=function(){if(m(this,U))this.host.updateComplete.then(()=>{this.host.shadowRoot&&(this.host.shadowRoot.querySelectorAll("style").forEach(n=>{n.remove()}),m(this,j).forEach(n=>{this.host.shadowRoot?.appendChild(n)}),m(this,G).forEach(n=>{this.host.shadowRoot?.appendChild(n)}))});else{if(!this.host.shadowRoot)return;this.host.shadowRoot.adoptedStyleSheets=[...m(this,I),...Array.from(m(this,Q).values())]}};Vt=function(){m(this,Ee)||(m(this,U)?this.host.updateComplete.then(()=>{this.host.shadowRoot&&this.host.shadowRoot.querySelectorAll("style").forEach(n=>{m(this,j).push(n),m(this,Ae).push(n.cloneNode(!0))})}):this.host.shadowRoot&&m(this,I).length===0&&(q(this,I,[...this.host.shadowRoot.adoptedStyleSheets||[]]),q(this,xe,[...m(this,I)])),q(this,Ee,!0))};function et(){try{return new CSSStyleSheet,!0}catch{return!1}}function kt(n){return n&&(n.includes("-")?n.split("-").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(""):n.charAt(0).toUpperCase()+n.slice(1))}var Mt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},Bt={};/*! *****************************************************************************
 ...
 */
  ...
  --gds-sys-shadow-2xl-02: 0px 0px 0px 0px transparent;`;var pn={};const Oe=typeof process<"u"&&pn!==void 0,Hn=/iPad|iPhone|iPod/.test(Oe?"":navigator.userAgent);var ze,Te,ke,tt,ve,Zt,Jt;function yn(){return Oe?[]:document.adoptedStyleSheets||[]}const gn=class Xt{constructor(){k(this,ve),k(this,ze,!et()),k(this,Te,new Map),k(this,ke,new Map),k(this,tt,yn())}static get instance(){return globalThis.__gdsGlobalStylesRegistryScoped?.[R]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[R]:new Xt}),globalThis.__gdsGlobalStylesRegistryScoped[R]}injectGlobalStyles(e,t){if(m(this,ze)){const s=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();z(this,ve,Zt).call(this,e,s)}else t.styleSheet&&z(this,ve,Jt).call(this,e,t.styleSheet)}};ze=new WeakMap;Te=new WeakMap;ke=new WeakMap;tt=new WeakMap;ve=new WeakSet;Zt=function(n,e){if(Oe)return;let t=m(this,ke).get(n);t||(t=document.createElement("style"),m(this,ke).set(n,t)),t.textContent=e,document.head.appendChild(t)};Jt=function(n,e){Oe||(m(this,Te).set(n,e),document.adoptedStyleSheets=[...m(this,tt),...Array.from(m(this,Te).values())])};let Sn=gn;const Yt=[Me`
    :host {
      ${P(qt)}
      ${P(Ft)}
    }
...
`;var Mn=kn;class J extends Cn(Tn(ye)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const e=this.constructor;return this.solid?e._solidSVG:e._regularSVG}applyStroke(e){return this.stroke?e.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):e}generateAttributesString(e){return Object.entries(e).filter(([t,s])=>s!==void 0).map(([t,s])=>`${t}="${s}"`).join(`
    ...
    `;return jt`${fn(s)}`}}J.styles=[Yt,Mn];v([E({...O,property:"height",selector:"svg"})],J.prototype,"size",2);v([Z({type:Boolean})],J.prototype,"solid",2);v([Z({type:Number})],J.prototype,"stroke",2);v([Z()],J.prototype,"level",2);v([E(xn("content"))],J.prototype,"color",2);v([Z({type:String})],J.prototype,"label",2);var _e,be,Ve;const Bn=class Kt{constructor(){k(this,_e,new Map),k(this,be,new Map),k(this,Ve,!et())}static get instance(){return globalThis.__gdsTransitionalStyles?.[R]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[R]:new Kt}),globalThis.__gdsTransitionalStyles[R]}apply(e,t){if(!e.shadowRoot)return;const s=m(this,_e).get(t);s&&(m(this,be).set(t,e),this.applyToElement(t,s))}applyToElement(e,t){const s=m(this,be).get(e);if(!s||!s.shadowRoot)return;const r=()=>{s._dynamicStylesController.clearInitial(),s._dynamicStylesController.inject("t-styles",P(t)),s._isUsingTransitionalStyles=!0},i=()=>{s._isUsingTransitionalStyles=!1,s._dynamicStylesController.clear("t-styles"),s._dynamicStylesController.restoreInitial()},l="[gds-element=gds-theme]";let h=s.getRootNode(),f=s.closest(l);for(;f===null&&h!==document;)f=h.host?.closest(l),h=h.host?.getRootNode();if(f){const g=f,y=()=>{g.designVersion==="2023"?i():r()};if(g.addEventListener("gds-design-version-changed",y),s.addEventListener("gds-element-disconnected",()=>g.removeEventListener("gds-design-version-changed",y)),g.designVersion==="2023"){i();return}}r()}register(e,t){let s=t;m(this,Ve)&&(s=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${t}`),m(this,_e).set(e,s),this.applyToElement(e,s)}};_e=new WeakMap;be=new WeakMap;Ve=new WeakMap;let Pn=Bn;function es(n,e){const t={waitUntilFirstUpdate:!1,...e};return(s,r,i)=>{const{update:l}=s,h=Array.isArray(n)?n:[n];s.update=function(f){h.forEach(g=>{const y=g;if(f.has(y)){const S=f.get(y),x=this[y];S!==x&&(!t.waitUntilFirstUpdate||this.hasUpdated)&&i.value?.call(this,S,x)}}),l.call(this,f)}}}let N=class extends J{};N._regularSVG='<path d="M6.75 12H17.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>';N._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M6 12C6 11.5858 6.33579 11.25 6.75 11.25H17.25C17.6642 11.25 18 11.5858 18 12C18 12.4142 17.6642 12.75 17.25 12.75H6.75C6.33579 12.75 6 12.4142 6 12Z" fill="currentColor"/>';N._name="minus-small";N._width=24;N._height=24;N._viewBox="0 0 24 24";N=v([Wt("gds-icon-minus-small")],N);let F=class extends ye{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2023"}connectedCallback(){super.connectedCallback(),Pn.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",P(`:host {${fe}}`))}render(){return le`<slot></slot>`}_onColorSchemeChange(){switch(this.colorScheme){case"dark":this._dynamicStylesController.inject("color-scheme",P(`:host { ${fe}}`));break;case"light":default:this._dynamicStylesController.inject("color-scheme",P(`:host { ${Ce}}`));break;case"auto":this._dynamicStylesController.inject("color-scheme",P(`:host { ${Ce}} @media (prefers-color-scheme: dark) { :host { ${fe} } }`));break}this.dispatchCustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}})}_onDesignVersionChange(){this.dispatchCustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}})}};F.styles=[Yt,Me`
      :host {
        display: contents;
        color: var(--gds-sys-color-content-neutral-01);
        font-family: var(--gds-sys-text-family);
      }
    `];v([Z({reflect:!0,attribute:"color-scheme"})],F.prototype,"colorScheme",2);v([Z({reflect:!0,attribute:"design-version"})],F.prototype,"designVersion",2);v([es("colorScheme")],F.prototype,"_onColorSchemeChange",1);v([es("designVersion")],F.prototype,"_onDesignVersionChange",1);F=v([Wt("gds-theme")],F);N.define();var On=Object.getOwnPropertyDescriptor,Dn=(n,e,t,s)=>{for(var r=s>1?void 0:s?On(e,t):e,i=n.length-1,l;i>=0;i--)(l=n[i])&&(r=l(r)||r);return r};F.define();globalThis.URLPattern||await Ne(()=>import("./index-DPyTNidZ.js"),[]);let Dt=class extends ne{constructor(){super(...arguments),this._router=new Qs(this,[{path:"/",render:()=>le`<h1>Green testbed</h1>`},{path:"/green-testbed/all-components",render:()=>le`<all-components></all-components>`,enter:(async n=>{await Ne(()=>import("./all-components-CUb1i5ej.js"),__vite__mapDeps([0,1]))})},{path:"/green-testbed/form",render:()=>le`<form-view></form-view>`,enter:(async n=>{await Ne(()=>import("./form-DR_CJHgt.js"),__vite__mapDeps([2,1]))})}])}createRenderRoot(){return this}render(){return le`<gds-theme><main>${this._router.outlet()}</main></gds-theme>`}};Dt=Dn([Ks("green-testbed-main")],Dt);export{xn as A,En as B,je as C,Wn as D,A as E,Nn as F,J as G,sn as H,P as I,N as J,fn as K,Sn as L,Hn as M,O as N,F as O,ee as T,Gn as Z,v as _,Me as a,dn as b,ln as c,Oe as d,cn as e,k as f,Wt as g,le as h,ne as i,z as j,m as k,q as l,Pn as m,ye as n,Yt as o,Z as p,zn as q,Cn as r,Tn as s,Ks as t,E as u,Vn as v,es as w,jt as x,qn as y,Fn as z};
