import{f as qd,u as Zd,i as Xd,V as fs,r as re,a as z,h as v,g as S,T as Ps,E as fe,x as Ce,Z as Kd}from"./index-CEOxH7av.js";/**
 * @license
...
`;var rc={};const Jn=typeof process<"u"&&rc!==void 0,ac=/iPad|iPhone|iPod/.test(navigator.userAgent);var xo,Ln,Wn,xr,_o,qa,wo,Za;function lc(){return Jn?[]:document.adoptedStyleSheets||[]}const dc=class Xa{constructor(){c(this,_o),c(this,wo),c(this,xo,!mr()),c(this,Ln,new Map),c(this,Wn,new Map),c(this,xr,lc())}static get instance(){return globalThis.__gdsGlobalStylesRegistry?.[fs]||(globalThis.__gdsGlobalStylesRegistry={...globalThis.__gdsGlobalStylesRegistry,[fs]:new Xa}),globalThis.__gdsGlobalStylesRegistry[fs]}injectGlobalStyles(t,s){if(a(this,xo)){const n=Array.isArray(s)?s.map(i=>i.toString()).join(""):s.toString();f(this,_o,qa).call(this,t,n)}else s.styleSheet&&f(this,wo,Za).call(this,t,s.styleSheet)}};xo=new WeakMap;Ln=new WeakMap;Wn=new WeakMap;xr=new WeakMap;_o=new WeakSet;qa=function(e,t){if(Jn)return;let s=a(this,Wn).get(e);s||(s=document.createElement("style"),a(this,Wn).set(e,s)),s.textContent=t,document.head.appendChild(s)};wo=new WeakSet;Za=function(e,t){Jn||(a(this,Ln).set(e,t),document.adoptedStyleSheets=[...a(this,xr),...Array.from(a(this,Ln).values())])};let Ka=dc;const G=[z`
    :host {
      ${re(ja)}
      ${re(Ua)}
    }
